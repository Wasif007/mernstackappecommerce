...
import {
    getSingleOrderMeAction,
  clearAllErrorFunc,
  updateSingleOrderAdmin,
...
const AdminUpdateOrderData = () => {
  ...
  const updateOrderSubmitHandler = (e) => {
    ...
    dispatch(updateSingleOrderAdmin(id, myForm));
  };
  ...
  useEffect(() => {
    ...
    if (isUpdated) {
      JSAlert.alert("Order Updated Successfully");
      dispatch({ type: ADMIN_ORDER_UPDATE_RESET });
    }

    dispatch(getSingleOrderMeAction(id));
...
export default AdminUpdateOrderData;